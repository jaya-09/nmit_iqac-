      ...
      <table class="tg" style="table-layout: fixed; width: 1479px">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="tg-0pky">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="6c3" id="6c3" value="option1">
                <label class="form-check-label" for="6c3">
                  Available with faculty
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="6c3" id="6c33" value="option2">
          ...
          <tr>
            ...
            <td class="tg-0pky">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="7c3" id="7c3" value="option1">
                <label class="form-check-label" for="7c3">
                  YES
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="7c3" id="7c33" value="option2">
          ...
          <tr>
            ...
            <td class="tg-0pky">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="7d3" id="7d3" value="option1">
                <label class="form-check-label" for="7d3">
                  YES
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="7d3" id="7d33" value="option2">
          ...
          <table class="tg" style="table-layout: fixed; width: 1479px">
            ...
            <tr>
              ...
              <td class="tg-0pky">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="12c3" id="12c3" value="option1">
                  <label class="form-check-label" for="12c3">
                    Effective
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="12c3" id="12c33" value="option2">
            ...
            <tr>
              ...
              <td class="tg-0pky">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="12d3" id="12d3" value="option1">
                  <label class="form-check-label" for="12d3">
                    Effective
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="12d3" id="12d33" value="option2">
