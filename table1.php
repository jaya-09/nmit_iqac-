...
if($_GET['id'] != NULL){
  ...
  $_SESSION['sub1'] = $row[10];
  $_SESSION['sub1co'] = $row[11];
  $_SESSION['sub2'] = $row[12];
  $_SESSION['sub2co'] = $row[13];
  $_SESSION['sub3'] = $row[14];
  $_SESSION['sub3co'] = $row[15];
  $_SESSION['sub4'] = $row[16];
  $_SESSION['sub4co'] = $row[17];
